...
const Home = () => {
  return (
    <main>
      ...
      <section className="flex justify-center flex-col gap-4 md:!mt-20 items-center mt-[-60px]">
        ...
        <div className="flex gap-4 flex-wrap mt-6 justify-center">
          {pricingCards.map((card) => (
            // WIP: Get free product from Stripe.
            <Card key={card.title} className={clsx("w-[300px] flex flex-col justify-between", {"border-2 border-primary": card.title === "Unlimited Saas"})}>
              ...
              <CardContent>
                ...
                {card.price !== "Free" && <span className="">/m</span>}
              </CardContent>
