...
import SubscriptionHelper from "@/components/global/SubscriptionHelper";
...
const page = async ({params: { agencyId }}: Props) => {
    ...
    <>
        ...
        <div className="flex flex-col lg:!flex-row justify-between gap-8">
            ...
            description={agencySubscription?.Subscription?.active === true ? currentPlanDetails?.description || "Let's get started" : "Let's get started! Pick a plan that works best for you."}
            duration="/ month"
            ...
            {addOns.data.map((addOn) => (
                ...
                highlightDescription="Get priority support and skip the long waiting list with the click of a button."
                />    
            ))}
        </div>
