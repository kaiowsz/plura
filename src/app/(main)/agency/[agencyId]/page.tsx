...
import { ClipboardIcon, Contact2, DollarSign, DollarSignIcon, Goal, ShoppingCart } from "lucide-react";
...
const AgencyIDPage = async ({params: {agencyId}, searchParams: {code}}: Props) => {
        ...
        <div className="absolute -top-10 -left-10 right-0 bottom-0 z-30 flex items-center justify-center backdrop-blur-md bg-background/50">
          <Card>
            <CardHeader>
              ...
              <Link href={`/agency/${agencyDetails.id}/launchpad`} className="p-2 w-fit bg-secondary text-white rounded-md flex items-center gap-2">
                <ClipboardIcon />
                Launch Pad
              </Link>
            </CardHeader>
      ...
      <div className="flex flex-col gap-4 pb-6">
        <div className="flex gap-4 flex-col xl:!flex-row">
          ...
          <Card className="flex-1 relative">
            <CardHeader>
              ...
              <CardDescription>
                <p className="mt-2">Reflects the number of sub accounts you own and manage.</p>
              </CardDescription>
            </CardHeader>
            <CardFooter>
        ...
        <div className="flex gap-4 xl:!flex-row flex-col">
          <Card className="p-4 flex-1">
            ...
            <AreaChart className="text-sm stroke-primary" data={
              [...(totalClosedSessions || []), ...(totalPendingSessions|| [])]
