...
const __getUsersWithAgencySubAccontPermissionsSidebarOptions = async (agencyId: string) => {
...
export type UsersWithAgencySubAccountPermissionsSidebarOptions = Prisma.PromiseReturnType<typeof __getUsersWithAgencySubAccontPermissionsSidebarOptions>;
...
export type PipelineDetailsWithCardsTagsTickets = Prisma.PromiseReturnType<typeof getPipelineDetails>;
